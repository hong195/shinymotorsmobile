    ...
    async componentWillMount() {
        ...
        try {
            ...
            if(deviceId == null) {
                ...
                console.log("FCM CHANGED TOKEN", deviceId + ' -- ' + fcmToken);
        ...
        await getSettings(acv).then((responseJson) => {
            ...
            try {
                ...
                if (responseJson.hasOwnProperty('main_color')) {
                    console.log('MC AAAAA', responseJson.main_color);
                    AsyncStorage.setItem('main_color', responseJson.main_color, () => {
                    });
                }

                if (responseJson.hasOwnProperty('secondary_color')) {
                    AsyncStorage.setItem('secondary_color', responseJson.secondary_color, () => {
                    });
                }

                if (responseJson.hasOwnProperty('grid_view_style')) {
                    AsyncStorage.setItem('gridViewStyle', responseJson.grid_view_style, () => {
                    });
                }

                if (responseJson.hasOwnProperty('inventory_view')) {
                    AsyncStorage.setItem('inventoryView', responseJson.inventory_view, () => {
                    });
                }

                if (responseJson.hasOwnProperty('api_key_android')) {
                    AsyncStorage.setItem('apiKeyAndroid', responseJson.api_key_android, () => {
                    });
                }

                if (responseJson.hasOwnProperty('api_key_ios')) {
                    AsyncStorage.setItem('apiKeyIos', responseJson.api_key_ios, () => {
                    });
                }
                ...
                if (responseJson.hasOwnProperty('currency_name')) {
                    AsyncStorage.setItem('currency_name', responseJson.currency_name, () => {
                    });
                }

                if (responseJson.hasOwnProperty('translations')) {
                    AsyncStorage.setItem('translations', responseJson.translations, () => {
                ...
                if (responseJson.hasOwnProperty('ads_settings')) {
                    AsyncStorage.setItem('ads_settings', responseJson.ads_settings, () => {
                    });
                } else {
                ...
                <ImageBackground source={require('./src/assets/img/launch_bg.jpg')}
                    ...
                    <View style={styles.container}>
                        ...
                        <View>
                            ...
                            <Text style={styles.text}><Translation str='vehicle_for_sale'/></Text>
                        </View>
                    </View>
                </ImageBackground>
            );
