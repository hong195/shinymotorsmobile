                        ...
                        <View style={styles.loginWrap}>
                            ...
                            <View style={styles.inputWrap}>
                                ...
                                <View style={styles.termPrivacy}>
                                    <Text style={styles.termPrivacyText}><Translation str='by_creating'/>
                                        <Text style={styles.termPrivacyTextLink} onPress={() => Linking.openURL('https://shinyviewmotors.com/shiny-view-motors-terms-conditions/') }><Translation str='terms_conditions'/> </Text><Translation str='and'/> <Text style={styles.termPrivacyTextLink} onPress={() => { Linking.openURL('https://shinyviewmotors.com/privacy-policy/') }}>
