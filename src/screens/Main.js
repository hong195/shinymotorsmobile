    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView refreshControl={
                    ...
                    <View>
                        ...
                        <View style={styles.recentWrap}>
                            <Text style={styles.mainTitle}><Translation str='recently_added'/></Text>
                            {this.state.viewType == 'main_ra_list_view' ?
                                <FlatList
                                    ...
                                    renderItem={({item}) =>
                                        <ListViewItem navigation={this.props.navigation} key={item.ID} invId={item.ID}
                                ...
                                <FlatList
                                    ...
                                    extraData={this.state}
                                    renderItem={({item}) =>
                                        <GridViewItem navigation={this.props.navigation} key={item.ID} invId={item.ID}
                                                      featureImg={item.imgUrl}
                ...
                <AppBottomNavigation navigation={this.props.navigation} activeTab='home3'/>
            </View>
        );
    }
}
